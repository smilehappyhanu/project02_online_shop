...
<section class="content">
    ...
    <div class="container-fluid">
        <form action="" method="PUT" id="editUserForm" name="editUserForm">
            @csrf
            <div class="card">
                <div class="card-body">								
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="email" id="email" class="form-control" placeholder="Email" autocomplete="off" value="{{ $user->email }}">	
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
