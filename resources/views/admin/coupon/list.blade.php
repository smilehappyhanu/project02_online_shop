                ...
                <form action="" method="get">
                    <div class="card-header">
                        <div class="card-title">
                            <button type="button" class="btn btn-default btn-sm" onclick=window.location.href="{{ route('coupons.index') }}">Reset</button>                      
                        </div>                  
                            ...
                            @if($discountCoupons->isNotEmpty())
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="text-danger w-4 h-4 mr-1" onclick="deleteCoupon('{{ $coupon->id }}')">
