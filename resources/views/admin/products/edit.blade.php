...
@section('content')
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <form action="" method="post" name="updateProductForm" id="updateProductForm">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card mb-3">
                            <div class="card-body">
                            ...
                            <div class="card-body">	
                                ...
                                <div class="mb-3">
                                    <select name="status" id="status" class="form-control">
                                        ...
                                        <option value="0" {{$product->status == 0 ? 'checked' : ''}}>Block</option>
                                    </select>
                                </div>
                            </div>
                        </div> 
...
<script>
    ...
    function deleteImage (id) {
        if (confirm("Are you sure you want to delete image ?")) {
            $("#image-row-" + id).remove();
            $.ajax({
            url: '{{route("product-images.delete",$product->id)}}',
            type: 'delete',
            data: {
                'id' : id
            },
